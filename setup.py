...
path_to_package_info = os.path.join('.', 'dwave', package_name, 'package_info.py')
if _PY2:
...
packages = ['dwave.{package_name}'.format(package_name=package_name)]
...
setup(
    ...
    url='https://github.com/dwavesystems/{package_name}'.format(package_name=package_name),
    license='Apache 2.0',
    packages=packages,
